...
DP.TDT.topKsnp.fn = function(file.name, N, K, eps=1, DP.method.name="exp.shd.apprx", B=20, shd.exact.score.file.name=NULL) {
...
dat.0 = dat.00[,-(1:4)]
names.dat = dat.0[,seq(3,dim(dat.0)[2], by=2)]
count.dat = dat.0[,seq(4,dim(dat.0)[2], by=2)]
rownames(dat.0) = dat.00[, 2]
